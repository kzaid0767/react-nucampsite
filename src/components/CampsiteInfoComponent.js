...
class CommentForm extends Component {
    ...
    handleSubmit(values){   
        this.toggleModal();
        this.props.postComment(this.props.campsiteId, values.rating, values.author, values.text); //addComment action creator is called using the values inputted in form
